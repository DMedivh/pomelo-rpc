...
Tracer.prototype.info = function (role, module, method, des) {
  if (this.isEnabled) {
    this.logger.info('Tracer', this.getLogger(role, module, method, des));
  }
  return;
};
...
Tracer.prototype.debug = function (role, module, method, des) {
  if (this.isEnabled) {
    this.logger.debug('Tracer', this.getLogger(role, module, method, des));
  }
  return;
};
...
Tracer.prototype.error = function (role, module, method, des) {
  if (this.isEnabled) {
    this.logger.error('Tracer', this.getLogger(role, module, method, des));
  }
  return;
};
